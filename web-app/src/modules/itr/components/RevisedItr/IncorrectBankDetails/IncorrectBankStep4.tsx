...
interface IncorrectBankStep4Props {
  selectedAy: string
...
export const IncorrectBankStep4: React.FC<IncorrectBankStep4Props> = ({
  selectedAy,
  uploadedDocuments,
  documentsError,
  onUpload,
  ...
  const requiredSlots: DocumentSlotItem[] = [
    ...
    { id: 'bank_statement', title: 'Bank Statements', subtitle: 'Cancelled cheque or passbook statement', isRequired: true, iconBg: '#d1fae5', iconColor: '#059669' },
  ]
